...
![Kubernetes Architecture](./img/01.%20Kubernetes-Architecture.png)
...
![K8s diagram](./img/K8s-diagram.jpg)
...
Minikube is an open-source tool that enables us to run Kubernetes clusters locally on our machines.As we now know that kubernetes is a container orchestration platform that automates the deployment, scaling, and management of containerized applications. Minikube streamlines the creation of a local Kubernetes environment, providing a user-friendly playground where we can safely build and test their applications before deploying them to a production setting.
...
![Choco install Minkube](./img/Choco%20install%20Minikube.png)

![Choco install minikube](./img/Choco%20install%20Minikube%20bottom.png)

Note: If you don't have chocolatey https://chocolatey.org/ installed, follow the official documentation to install it https://chocolatey.org/.
...
Go to docker desktop official documentation to install it if not installed. https://docs.docker.com/desktop/install/windows-install/

![Doker desktop](./img/Docker%20desktop.png)
...
![Launched terminal](./img/Launched%20terminal.png)
...
![Sudo apt get](./img/Sudo%20apt%20get.png)
...
![Install ca certificate](./img/Install%20ca%20certificate.png)
...
![Download docker linux](./img/download%20docker%20linux.png)

This downloads the Docker GPG key using curl

sudo chmod a+r /etc/apt/keyrings/docker.gpg

![Chmod a+r](./img/chmod%20a+r.png)
...
![Sudo apt get update](./img/Sudo%20apt%20get%20update.png)

#### Install latest version of docker

sudo apt-get install docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin

![Docker build](./img/Docker%20build%20top.png)
...
![Sudo system](./img/Sudo%20system%20status.png)

iii. Install minikube

curl -LO https://storage.googleapis.com/minikube/releases/latest/minikube_latest_amd64.deb

![Minikube release](./img/Minikube%20release.png)

If you get an error after running the command above, reach out to the technical support.

sudo dpkg -i minikube_latest_amd64.deb

![Sudo minikube](./img/Sudo%20minikube.png)

![Minikube latest](./img/Minikube%20latest.png)

iv. Start minikube

minikube start --driver=docker 

![Minikube start driver](./img/Minikube%20start%20driver.png)
...
iv. Just like windows and linux, we need docker desktop as a driver for minikube. TO install docker desktop for mac go to docker desktop official documentation to install it if not installed. https://docs.docker.com/desktop/install/mac-install/

v. Run the command below to start minikube using virtualbox as the driver.

minikube start --driver=docker

I do not use MAC computer.
