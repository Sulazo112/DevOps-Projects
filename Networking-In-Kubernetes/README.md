...
[Multi container](./img/MultiContainer.png)

![Multi container YAML](./img/Multi%20container%20YAML.png)
...
metadata: Contains metadata for the Pod, including the name of the Pod, which is set to "multi-container-pod." spec: Describes the desired state of the Pod.
...
![Apply Pod config.](./img/Apply%20Pod%20config..png)

![Apply Pod configuration](./img/Apply%20Pod%20configuration.png)

3. Check Pod Status and Logs:

kubectl get pods kubectl logs multi-container-pod -c container-1 kubectl logs multi-container-pod -c container-2

![Kubectl get pods](./img/Kubectl%20get%20pods.png)

![Kubectl multi container log](./img/Kubectl%20multi%20container%20log.png)

![Logs multi container](./img/Logs%20multi%20container.png)
...
![Access nginx](./img/Access%20nginx%20.png)

Now, within the BusyBox container, we can use tools like curl or wget to access http://localhost and see the Nginx page.
